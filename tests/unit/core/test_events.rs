...
fn test_event_creation() {
    let event = Event::new(EventType::UserInput("Hello".to_string()), "test_source".to_string());
...
fn test_event_bus_publish() {
    let bus = EventBus::new();
    let event = Event::new(EventType::UserInput("test".to_string()), "test_source".to_string());
...
fn test_event_bus_subscribe_and_receive() {
    ...
    let event = Event::new(EventType::AgentMessage("test message".to_string()), "test_source".to_string());
...
fn test_event_filter_with_source() {
    ...
    let event_a = Event::new(EventType::UserInput("test".to_string()), "source_a".to_string());
    let event_b = Event::new(EventType::UserInput("test".to_string()), "source_b".to_string());
...
fn test_event_filter_with_destination() {
    ...
    let event_c = Event::new(EventType::UserInput("test".to_string()), "source".to_string());
