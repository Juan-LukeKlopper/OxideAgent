...
impl MockOllamaClient {
    ...
    pub async fn send_chat(
        ...
        let content = response["message"]["content"].as_str().unwrap_or("Default mock response").to_string();
...
mod tests {
    ...
    fn test_mock_shell_executor() {
        ...
        // Test logging
        assert_eq!(shell.get_call_log(), vec!["echo hello".to_string(), "invalid_command".to_string()]);
    }
